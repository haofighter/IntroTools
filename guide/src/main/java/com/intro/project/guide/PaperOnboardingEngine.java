package com.intro.project.guide;
...
import com.intro.project.guide.listeners.AnimatorEndListener;
import com.intro.project.guide.listeners.OnSwipeListener;
import com.intro.project.guide.listeners.PaperOnboardingOnChangeListener;
import com.intro.project.guide.listeners.PaperOnboardingOnLeftOutListener;
import com.intro.project.guide.listeners.PaperOnboardingOnRightOutListener;
import com.intro.project.guide.utils.PaperOnboardingEngineDefaults;
...
//        elementIcon.setImageResource(iconDrawableRes);
        elementIcon.setImageBitmap(new BitmapUtils().toRoundBitmap(BitmapFactory.decodeResource(mAppContext.getResources(), iconDrawableRes)));
        if (isActive) {
