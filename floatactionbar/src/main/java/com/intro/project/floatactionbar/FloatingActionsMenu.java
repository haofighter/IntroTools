package com.intro.project.floatactionbar;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            if (!expandsHorizontally()) {
                LinearLayout label = (LinearLayout) child.getTag(R.id.fab_label);
                if (label != null) {
        ...
        if (mExpanded) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                if (getChildAt(i) instanceof FloatingActionButton) {
                    ((FloatingActionButton) getChildAt(i)).dissmiss();
                }
            }
    ...
    public void toggle() {
        if (mExpanded) {
            for (int i = 0; i < getChildCount(); i++) {
                if (getChildAt(i) instanceof FloatingActionButton) {
                    if (((FloatingActionButton) getChildAt(i)).getLabelView() != null)
                        ((FloatingActionButton) getChildAt(i)).getLabelView().setVisibility(View.GONE);
                }
            }
            collapse();
        } else {
