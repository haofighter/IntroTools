...
public class FloatingActionButton extends ImageButton {
    ...
    public void setTitle(String title) {
        mTitle = title;
        LinearLayout label = getLabelView();
    ...
    public void setElseView(View view) {
        if (getLabelView() != null) {
            getLabelView().removeAllViews();
            getLabelView().addView(view);
        }
    }


    public LinearLayout getLabelView() {
        return (LinearLayout) getTag(R.id.fab_label);
    }
