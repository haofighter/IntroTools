...
package com.intro.hao.mytools.customview.FlowingDraw;
...
public abstract class ElasticDrawer extends ViewGroup {
    ...
    protected void setOffsetPixels(float offsetPixels, float eventY, int type) {
        ...
        mMenuView.setClipOffsetPixels(mOffsetPixels, eventY, type);//设置弹跳动画部分
        if (newOffset != oldOffset) {
            onOffsetPixelsChanged(newOffset);//移动布局
