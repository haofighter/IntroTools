package com.intro.hao.mytools.customview.verticaltablayout;
...
import com.intro.hao.mytools.customview.verticaltablayout.adapter.TabAdapter;
import com.intro.hao.mytools.customview.verticaltablayout.util.DisplayUtil;
import com.intro.hao.mytools.customview.verticaltablayout.util.TabFragmentManager;
import com.intro.hao.mytools.customview.verticaltablayout.widget.QTabView;
import com.intro.hao.mytools.customview.verticaltablayout.widget.TabView;
...
public class VerticalTabLayout extends ScrollView {
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColorIndicator = typedArray.getColor(R.styleable.VerticalTabLayout_indicatortab_color,
                context.getResources().getColor(R.color.colorAccent));
        mIndicatorWidth = (int) typedArray.getDimension(R.styleable.VerticalTabLayout_indicatortab_width, DisplayUtil.dp2px(context, 3));
        mIndicatorCorners = typedArray.getDimension(R.styleable.VerticalTabLayout_indicatortab_corners, 0);
        mIndicatorGravity = typedArray.getInteger(R.styleable.VerticalTabLayout_indicatortab_gravity, Gravity.LEFT);
