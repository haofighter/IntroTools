...
public class StatusBarUtil {
     ...
     * @param v        控件
     * @param t        时间
     * @param isDismis 显示模式 true 收缩  false 展开
     * @return
     */
    ...
    public static void setAnimal(View v, long t, boolean isDismis, Animator.AnimatorListener animatorListener) {
        ...
        Animator animator;
        if (isDismis) {
            animator = ViewAnimationUtils.createCircularReveal(v, width / 2, height / 2, radius, 0);
        } else {
     ...
     * @param isShow
     */
    public static void setStateBarShow(boolean isShow, Activity activity) {
        if (isShow) {
     ...
     *
     * @param color   颜色(非ID)
     * @param isShade 是否需要渐变效果
     */
    public static void changeViewColor(View view, int color, boolean isShade) {
        if (isShade) {
            for (int i = 0; i < 100; i++) {
                if (i < 50) {
                    view.setBackgroundColor(Color.argb(255 * i / 50, (color & 0xff0000) >> 16, (color & 0x00ff00) >> 8, color & 0x0000ff));
                } else {
                    view.setBackgroundColor(Color.argb(255 * (i - 50) / 50, (color & 0xff0000) >> 16, (color & 0x00ff00) >> 8, color & 0x0000ff));
                }
            }
        } else {
    ...
    public static void changeViewColor(View view, int color) {
        changeViewColor(view, color, true);
    }
