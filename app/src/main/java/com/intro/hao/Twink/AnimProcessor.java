...
public class AnimProcessor {
    ...
    public void scrollHeadByMove(float moveY) {
        ...
        if (cp.getHeader().getVisibility() != View.VISIBLE) cp.getHeader().setVisibility(View.VISIBLE);

        if (cp.isPureScrollModeOn()) cp.getHeader().setVisibility(View.GONE);
    ...
    public void scrollBottomByMove(float moveY) {
        ...
        if (cp.getFooter().getVisibility() != View.VISIBLE) cp.getFooter().setVisibility(View.VISIBLE);

        if (cp.isPureScrollModeOn()) cp.getFooter().setVisibility(View.GONE);
    ...
    private ValueAnimator.AnimatorUpdateListener overScrollTopUpListener = new ValueAnimator.AnimatorUpdateListener() {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            if (cp.isOverScrollTopShow()) {
                cp.getHeader().getLayoutParams().height = height;
                cp.getHeader().requestLayout();
            } else cp.getHeader().setVisibility(View.GONE);
    ...
    private ValueAnimator.AnimatorUpdateListener overScrollBottomUpListener = new ValueAnimator.AnimatorUpdateListener() {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            if (cp.isOverScrollBottomShow()) {
                cp.getFooter().getLayoutParams().height = height;
                cp.getFooter().requestLayout();
            } else cp.getFooter().setVisibility(View.GONE);
            cp.getContent().setTranslationY(-height);
            cp.onPullUpReleasing(height);
        }
    };
